...
*/
    ...
    private boolean isValidBST(Node node, E min, E max) {
        ...
        // Violación por límite mínimo
        if (min != null &&
            node.data.compareTo(min) <= 0) {

            return false;
        }

        // Violación por límite máximo
        if (max != null &&
